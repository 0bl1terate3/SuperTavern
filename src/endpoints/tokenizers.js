...
const commandRTokenizer = new WebTokenizer('https://github.com/SuperTavern/SuperTavern-Tokenizers/raw/main/command-r.json.gz', 'src/tokenizers/llama3.json');
const commandATokenizer = new WebTokenizer('https://github.com/SuperTavern/SuperTavern-Tokenizers/raw/main/command-a.json.gz', 'src/tokenizers/llama3.json');
const qwen2Tokenizer = new WebTokenizer('https://github.com/SuperTavern/SuperTavern-Tokenizers/raw/main/qwen2.json.gz', 'src/tokenizers/llama3.json');
const nemoTokenizer = new WebTokenizer('https://github.com/SuperTavern/SuperTavern-Tokenizers/raw/main/nemo.json.gz', 'src/tokenizers/llama3.json');
const deepseekTokenizer = new WebTokenizer('https://github.com/SuperTavern/SuperTavern-Tokenizers/raw/main/deepseek.json.gz', 'src/tokenizers/llama3.json');
