...
async function preSetupTasks() {
    ...
    console.log();
    console.log(`SuperTavern ${version.pkgVersion}`);
...
async function postSetupTasks(result) {
    ...
    setWindowTitle('SuperTavern WebServer');

    let logListen = 'SuperTavern is listening on';
    ...
    const goToLog = `Go to: ${color.blue(browserLaunchUrl)} to open SuperTavern`;
