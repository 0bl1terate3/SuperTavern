...
let ASSETS_JSON_URL = 'https://raw.githubusercontent.com/SuperTavern/SuperTavern-Content/main/index.json';


// DBG
//if (DEBUG_TONY_SAMA_FORK_MODE)
//    ASSETS_JSON_URL = "https://raw.githubusercontent.com/Tony-sama/SuperTavern-Content/main/index.json"
let availableAssets = {};
let currentAssets = {};
            ...
            .then(async function(json) {
                ...
                for (const assetType of assetTypes) {
                    ...
                    for (const i in availableAssets[assetType].sort((a, b) => a?.name && b?.name && a['name'].localeCompare(b['name']))) {
                        ...
                        //if (DEBUG_TONY_SAMA_FORK_MODE)
                        //    asset["url"] = asset["url"].replace("https://github.com/SuperTavern/","https://github.com/Tony-sama/"); // DBG
