 ...
 * @property {boolean} listen If SuperTavern is listening on all network interfaces
 ...
 * @property {boolean} browserLaunchEnabled If automatically launch SuperTavern in the browser
...
export class CommandLineParser {
    ...
    getDefaultConfig(isGlobal) {
        const appPaths = envPaths('SuperTavern', { suffix: '' });
    ...
    parse(args) {
        const cliArguments = yargs(hideBin(args))
            ...
            .option('browserLaunchEnabled', {
                type: 'boolean',
                default: null,
                describe: 'Automatically launch SuperTavern in the browser',
            })
